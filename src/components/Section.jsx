...
const Section = (props) => {
	...
	return (
		...
		>
			...
			<img
				src={track}
				className='absolute left-0 top-1/2 -z-10 h-full w-full -translate-y-1/2 select-none bg-transparent object-cover object-bottom opacity-0 group-even:hidden'
